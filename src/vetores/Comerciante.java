...
public class Comerciante {
	...
	public static void main(String[] args) {
		 ...
		 * um conjunto de N mercadorias, cada uma contendo nome, preço de 
		 * compra e preço de venda das mesmas. 
		 * Fazer um programa que leia tais dados e determine e escreva 
		 * quantas mercadorias proporcionaram:
		 * 		lucro < 10%
		 * 		10% ≤ lucro ≤ 20%
		 * 		lucro > 20%
		 * Determine e escreva também o valor total de compra e de venda 
